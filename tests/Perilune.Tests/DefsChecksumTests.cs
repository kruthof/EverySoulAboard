...
namespace Perilune.Tests
{
    ...
    public class DefsChecksumTests
    {
        ...
        /// (`3acb4396949b164b` at the time of writing). The two are not interchangeable and the
        ...
        public void SimDefsDefaultChecksum_IsPinned_NotTheScenarioHostsRulesInclusiveValue()
        {
            ...
            const ulong Pinned = 0x4143A305738652DCUL; // wreck start W2 half A (wear.wreck_threshold)
        ...
        /// <c>defs: 3acb4396949b164b (18 files, 0 problems, 1 rules)</c>. That is the value lanes
        /// copy into handovers — and it is NOT
        /// <see cref="SimDefsDefaultChecksum_IsPinned_NotTheScenarioHostsRulesInclusiveValue"/>'s
        /// `4143a305738652dc`, which is the compiled-in defaults with no rules. Pinning only one of
        ...
        ///
        ///   SimDefs.Default.Checksum      = 4143a305738652dc   compiled-in defaults, no rules
        ///   shipped .def + rules/*.moss   = 3acb4396949b164b   what the console prints
        ...
        public void ShippedDefsPlusRulesChecksum_IsPinned_ThisIsTheValueTheScenarioHostPrints()
        {
            ...
            const ulong Pinned = 0x3ACB4396949B164BUL; // wreck start W2 half A (wear.wreck_threshold)
            ...
            Assert.That(defs.Checksum, Is.EqualTo(Pinned),
                ...
                "  (4143a305738652dc), which folds no designer rules — see the sibling test.\n" +
