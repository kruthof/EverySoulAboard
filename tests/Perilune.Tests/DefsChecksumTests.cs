...
namespace Perilune.Tests
{
    ...
    public class DefsChecksumTests
    {
        ...
        /// (`4c15dffe98a2cda8` at the time of writing). The two are not interchangeable and the
        ...
        public void SimDefsDefaultChecksum_IsPinned_NotTheScenarioHostsRulesInclusiveValue()
        {
            ...
            const ulong Pinned = 0x62A1BB2633C447BEUL; // E0-6+E0-7 wave (Seals + commission cost; ice + melter buffer)
        ...
        /// <c>defs: 4c15dffe98a2cda8 (18 files, 0 problems, 1 rules)</c>. That is the value lanes
        /// copy into handovers — and it is NOT
        /// <see cref="SimDefsDefaultChecksum_IsPinned_NotTheScenarioHostsRulesInclusiveValue"/>'s
        /// `62a1bb2633c447be`, which is the compiled-in defaults with no rules. Pinning only one of
        ...
        ///
        ///   SimDefs.Default.Checksum      = 62a1bb2633c447be   compiled-in defaults, no rules
        ///   shipped .def + rules/*.moss   = 4c15dffe98a2cda8   what the console prints
        ...
        public void ShippedDefsPlusRulesChecksum_IsPinned_ThisIsTheValueTheScenarioHostPrints()
        {
            ...
            const ulong Pinned = 0x4C15DFFE98A2CDA8UL; // E0-6+E0-7 wave (Seals + commission cost; ice + melter buffer)
            ...
            Assert.That(defs.Checksum, Is.EqualTo(Pinned),
                ...
                "  (62a1bb2633c447be), which folds no designer rules — see the sibling test.\n" +
