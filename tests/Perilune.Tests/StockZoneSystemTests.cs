...
namespace Perilune.Tests
{
    ...
    public class StockZoneSystemTests
    {
        ...
        /// exercise a real mask, an accept-NOTHING mask (0), and an all-bits mask, in canonical
        /// packed-position order.
        ///
        ...
        public void ZoneChapter_RoundTripsAPopulatedRegistry_BitExactly()
        {
            ...
            zones.SetFilter(sim, new Int3(3, 1, 0), ~0UL);              // all bits set
