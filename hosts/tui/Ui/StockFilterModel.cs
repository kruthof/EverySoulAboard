...
namespace Perilune.Tui.Ui
{
    ...
    public static class StockFilterModel
    {
        ...
        /// order.
        ///
        /// E0-7 CORRECTION: this type used to work off the member COUNT and treat a kind as an index
        /// in <c>0..KindCount-1</c>. That is only right while <see cref="ItemKind"/> is CONTIGUOUS,
        /// and it stopped being contiguous the moment E0-7 took <c>Ice = 8</c> over the slot 7 the
        /// integrator had reserved for E0-6's <c>Seals</c>. Under the count form the TUI's cursor
        /// would have offered a kind 7 that does not exist, refused to reach Ice at all, and
        /// <see cref="AcceptAllMask"/> would have set bit 7 and cleared bit 8 — "accept everything"
        /// silently refusing the one kind the package added.
        /// </summary>
        ...
        public static readonly string[] Labels =
        {
            ...
            "ICE",       // ItemKind.Ice               (8 — 7 is reserved for E0-6's Seals)
        };
