...
| T16 | Persona window (ONE door to a person) | — | **M4-1 charter WRITTEN 2026-08-04** (`perilune-m4.packages.md` §5: layout/tabs/orders/transcript + the T-key third door + mount ruled or forked as design questions (a)–(h); owner review + five-item batch OPEN; playtest 08-07 findings amend before M4-2 builds) |
