...
> it** — the runs that appeared to were zoning a sealed compartment (see the ⛔ RETRACTED block in the
> E0-4 section above). The advice "do not zone stockpiles in any authored ship" still stands, but the
