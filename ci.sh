...
printf '%s\n' "$OUT" | grep -q "9daef6183e673d6b" || { echo "FAIL: reference hash changed (expected 9daef6183e673d6b) — if intended, update ci.sh + CLAUDE.md + memory in the same commit"; exit 1; }
