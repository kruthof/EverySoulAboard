...
printf '%s\n' "$OUT" | grep -q "43345ff0c9d62684" || { echo "FAIL: reference hash changed (expected 43345ff0c9d62684) — if intended, update ci.sh + CLAUDE.md + memory in the same commit"; exit 1; }
