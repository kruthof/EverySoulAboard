...
printf '%s\n' "$OUT" | grep -q "16043bfb148ae326" || { echo "FAIL: reference hash changed (expected 16043bfb148ae326) — if intended, update ci.sh + CLAUDE.md + memory in the same commit"; exit 1; }
