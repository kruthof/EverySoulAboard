...
printf '%s\n' "$OUT" | grep -q "494ad0b05a154ccb" || { echo "FAIL: reference hash changed (expected 494ad0b05a154ccb) — if intended, update ci.sh + CLAUDE.md + memory in the same commit"; exit 1; }
