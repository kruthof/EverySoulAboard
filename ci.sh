...
printf '%s\n' "$OUT" | grep -q "ec16281d9f78d886" || { echo "FAIL: reference hash changed (expected ec16281d9f78d886) — if intended, update ci.sh + CLAUDE.md + memory in the same commit"; exit 1; }
