...
// It is a HIGH-VALUE GRAPHITE (luma ≈ 39) against true-black space, so the ship's outline
// reads at every zoom instead of dissolving into the void — while still sitting a clear step
// BELOW the dimmest explored room, so "not yet seen" never outshines "seen but dark".
...
//   space / known-void      FG[Unknown] = FG[Void] = #050409     ~   5   true black
//   hull mass + fog         HULL        = #282531               ~  39   graphite silhouette
