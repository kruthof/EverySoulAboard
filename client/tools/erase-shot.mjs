...
// 17 -> 18: M3-10 added HEATER. 18 -> 21 (2026-08-04): GROWBED, MEDBED and TABLE. This harness is
// not in ./ci.sh, so a stale number here would have gone unnoticed until the next person ran it —
// moved in the same commit as the tools, both times.
check((await evaluate(`document.querySelectorAll('#rz-palette .rz-tool').length`)) === 21, 'the palette paints 21 tools');
